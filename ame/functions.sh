...
mac80211e() {
    ...
    $iptables -t mangle -A W80211e -m dscp --dscp-class CS6 -j CLASSIFY  --set-class 0:106 -m comment --comment  'Critical (VO)'
    $iptables -t mangle -A W80211e -m dscp --dscp $ANT -j CLASSIFY       --set-class 0:105 -m comment --comment  'Ants(VI)'
    $iptables -t mangle -A W80211e -m dscp --dscp $BOFH -j CLASSIFY      --set-class 0:105 -m comment --comment  'Typing (VI)'
    ...
    $iptables -t mangle -A W80211e -m dscp --dscp-class CS1 -j CLASSIFY  --set-class 0:102 -m comment --comment  'Background (BK)'
